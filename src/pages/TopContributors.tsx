...
export default function TopContributors() {
  ...
  return (
    <div className="max-w-3xl mx-auto w-full pb-20 animate-in fade-in duration-300">
      ...
      <div className="sticky top-16 z-20 bg-mamas-bg/95 backdrop-blur-md py-4 mb-4 border-b border-slate-200/60 dark:border-slate-800/60 flex items-center justify-between">
        <div>
