  ...
  return (
    <div className="max-w-4xl mx-auto w-full pb-20 animate-in fade-in duration-300">
      ...
      <div className="sticky top-16 z-30 bg-mamas-bg/95 backdrop-blur-md py-3.5 border-b border-slate-200/60 dark:border-slate-800/60 mb-5 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs font-medium text-slate-500 dark:text-slate-400 mt-0.5">
            Connect with verified MAMAS members
          </p>
        </div>
      ...
      {appSettings?.whatsappGroupLink && (
        <div className="bg-emerald-50 dark:bg-emerald-950/20 rounded-3xl p-4 shadow-xs border border-emerald-100 dark:border-emerald-900/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-10 h-10 rounded-2xl bg-emerald-500 text-white flex items-center justify-center shrink-0 shadow-xs shadow-emerald-500/20">
          ...
          <div className="shrink-0">
            <a 
              ...
              className="block w-full sm:w-auto bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-2 px-4 rounded-xl text-xs shadow-xs shadow-emerald-500/20 active:scale-95 transition-all text-center cursor-pointer"
            >
              Join Group
            </a>
          </div>
      ...
      <div className="bg-white dark:bg-[#0c1731] py-3 px-2 sm:px-4 border-b border-slate-200/60 dark:border-slate-800/60 flex flex-col sm:flex-row gap-3 mb-5">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 rounded-2xl text-xs sm:text-sm font-medium text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder:text-slate-400"
          />
        </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs font-medium text-slate-500 dark:text-slate-400 truncate flex items-center gap-1.5 mt-0.5">
                      <School className="w-3.5 h-3.5 text-blue-500 dark:text-blue-400 shrink-0" /> 
                      <span>{member.yearLeftSchool ? `Class of ${member.yearLeftSchool}` : 'Alumni'}</span>
                      {member.district && canViewField(member, 'location') && <span className="opacity-50">•</span>}
              ...
              <div className="px-6 pb-6 relative">
                ...
                <div className="-mt-14 mb-3 flex justify-center relative z-10">
                  {selectedMember.profilePictureUrl ? (
                    <img src={selectedMember.profilePictureUrl} alt={selectedMember.fullName} className="w-28 h-28 rounded-2xl object-cover border-4 border-white dark:border-[#0c1731] bg-white dark:bg-[#0c1731] shadow-md" referrerPolicy="no-referrer" />
                  ) : (
