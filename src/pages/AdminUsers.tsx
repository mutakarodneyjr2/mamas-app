        ...
        {filteredUsers.map(user => {
          ...
          return (
            ...
            >
              ...
              {/* Expanded Details */}
              {isExpanded && (
                <div className="border-t border-slate-100 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/40 p-4 sm:p-5 rounded-b-3xl animate-in slide-in-from-top-2 duration-200">
